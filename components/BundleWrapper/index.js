    ...
    return (
        <div className="up-view-table my-4">
            ...
            <div className="position-relative pb-4">
                {cart.lines.map((line,idx) => <div key={line.id} className="d-flex align-items-center justify-content-between pb-3">
                    <div className="block-item d-flex align-items-center position-relative px-4 py-2 flex-fill">
                ...
                {data.draw.type==='millionaire' && <div className="d-flex align-items-center justify-content-between pb-3">
                    <div
                        className="block-item d-flex align-items-center position-relative px-5 ms-3 py-2 flex-fill">
                        <div className="d-flex align-items-center">
                ...
                <div className="px-4">
                    <div className="bgGrayColor p-3 rounded-3 d-flex align-items-center justify-content-between">
                        <div />
                        <div className="d-flex align-items-center">
                            {showCopyText && <span className={'me-3'}>Copied</span>}
