...

                    {
                        ...
                        <div className='section-fading bgGrayColor rounded-3 p-3 my-4'>
                            ...
                            <div className='info-brand mx-3 rounded-3 bgWhiteColor p-3 my-3'>
                                <p className='text-center fw-light'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,</p>
                            </div>
                            :
                            null
                            }
